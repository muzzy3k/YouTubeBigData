...
# %%
pipeline_model.write().overwrite().save("models_CA/pipeline_model")
lr_model_cr.write().overwrite().save("models_CA/lr_model_cr")
lr_model_lr.write().overwrite().save("models_CA/lr_model_lr")
